...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_encrypt.setGeometry(QtCore.QRect(160, 510, 75, 23))
        self.btn_encrypt.setObjectName("btn_encrypt")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(570, 510, 75, 23))
        ...
        self.txt_plain_text.setGeometry(QtCore.QRect(130, 100, 651, 131))
        self.txt_plain_text.setObjectName("txt_plain_text")
        self.txt_key = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(130, 240, 651, 41))
        self.txt_key.setObjectName("txt_key")
        self.txt_cipher_text = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_cipher_text.setGeometry(QtCore.QRect(130, 330, 651, 141))
